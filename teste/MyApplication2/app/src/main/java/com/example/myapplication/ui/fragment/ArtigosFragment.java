...
import com.example.myapplication.ui.viewmodel.ArtigosViewModel;

public class ArtigosFragment extends Fragment {

    private ArtigosViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(ArtigosViewModel.class);
